...
var $DateTimeInput = document.querySelector("#Date"); // Variable for Date Time Input search category in our HTML, which will be used in our handleSearchButtonClick() function
var $CityInput = document.querySelector("#City"); // Variable for City Input search category in our HTML, which will be used in our handleSearchButtonClick() function
var $StateInput = document.querySelector("#State"); // Variable for State Input search category in our HTML, which will be used in our handleSearchButtonClick() function
...
var $ShapeInput = document.querySelector("#Shape"); // Variable for Shape Input search category in our HTML, which will be used in our handleSearchButtonClick() function
